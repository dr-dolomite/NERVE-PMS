                    ...
                    <div className="flex h-full max-h-screen flex-col gap-2">
                        ...
                        <div className="flex-1">
                            <nav className="grid items-start lg:space-y-2 px-2 lg:py-6 py-2 text-lg font-medium lg:px-4">
                                <Link
                                    href="/dashboard/home"
                                    className={`flex items-center gap-3 rounded-lg antialiased px-3 lg:py-3 py-2 transition-all ${pathname == "/dashboard/home" ? "bg-gradient-to-r from-blue-500 to-cyan-500 text-white" : "text-primary"}`}
                                >
                                ...
                                <Link
                                    ...
                                    className={`flex items-center gap-3 rounded-lg antialiased px-3 lg:py-3 py-2 transition-all ${pathname == "/dashboard/records" ? "bg-gradient-to-r from-blue-500 to-cyan-500 text-white" : "text-primary`"}`}
                                >
