...
const DashboardLayout = ({ children }: { children: ReactNode }) => {
    ...
    return (
        // <RoleGate allowedRole={UserRole.DOCTOR}>
                        ...
                        <div className="flex-1">
                            <nav className="grid items-start lg:space-y-2 px-2 lg:py-6 py-2 text-lg font-medium lg:px-4">
                                <Link
                                    ...
                                    className={`flex items-center gap-3 rounded-lg antialiased px-3 lg:py-3 py-2 transition-all ${pathname.startsWith("/doctor/dashboard/patient")
