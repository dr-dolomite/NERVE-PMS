...
const FollowUpForm = () => {
    ...
    const FormRecords: FormRecordProps[] = [
        {
            title: "Lab Results",
            description: "Add or Update the Lab Results of the Patient",
            name: "lab",
        },

        {
            title: "Chief Complaint",
            description: "Add Chief Complaint of the Patient",
            name: "chiefComplaint",
        },
        {
            title: "S/O",
            description: "Add or Update the S/O of the Patient",
            name: "so",
        },
        {
            title: "Diagnosis",
        ...
        {
            title: "Treatment",
            description: "Add or Update the Treatment of the Patient",
            name: "treatment",
        },
    ]
